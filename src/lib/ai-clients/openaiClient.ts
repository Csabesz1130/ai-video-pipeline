...
export class OpenAIHelper {
  ...
  async generateOptimizedScript(brief: any, platform: string) {
    ...
    const prompt = 
      Create a short-form video script for  about 
      Target audience: 
      Style: 
      Hook type:  (primary),  (secondary)
      
      The script should:
      1. Open with an extremely engaging hook (first 3 seconds)
      2. Deliver key message clearly and concisely
      3. Include appropriate pacing for 
      4. End with a strong call to action
      
      Format the script with timing guidance and visual cues.
    ;
